...
- `current_input_file`: the global context split/upload mode; it is enabled by default and uploads the full context as a `HRIDS_HISTORY.txt` context file once the character threshold is reached.
